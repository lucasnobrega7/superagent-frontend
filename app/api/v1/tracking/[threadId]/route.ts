...
/**
 * API para gerenciamento de threads específicas do LiteralAI
 */
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({ error: 'Erro ao obter thread' }, { status: 500 });
    }
  } catch (error) {
    console.error('Erro na rota de obtenção de thread:', error);
